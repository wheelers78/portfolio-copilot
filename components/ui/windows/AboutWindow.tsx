...
export default function AboutWindow() {
  return (
    <div className="space-y-4">
      ...
      <p className="text-[24px] font-sans leading-snug text-[var(--text-primary)] pb-4">
      ...
      <p className="text-[16px] font-sans leading-snug text-[var(--text-primary)]">
        My current focus is exploring how AI can be used to amplify our craft and collapse the gap between idea and execution.
        </p>
